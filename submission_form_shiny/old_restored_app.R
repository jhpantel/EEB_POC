...
#      })
      ...
      observeEvent(input$submitselected, {
        # Get the Google Drive sheet
        message(paste(input$works_dt_rows_selected))
#        message("prettytable")
#        message(prettytable()[input$works_dt_rows_selected[1],])
        message("workstable")
#        message(data.frame(workstable)[input$works_dt_rows_selected[1],])
        message(paste(colnames(data.frame(workstable))))
#        message("DT")
#        message(dt_proxy[input$works_dt_rows_selected[1],])

        wb <- drive_get("shiny_workstable_output_testy_test")
        ...
        googlesheets4::sheet_append(data = workstable[input$works_dt_rows_selected,], ss=wb)
